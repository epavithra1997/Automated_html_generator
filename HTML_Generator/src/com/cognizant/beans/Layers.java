...
public class Layers {
	...
	private String text;
	public Layers(List<String> bottom, float click_x, float click_y,
			List<String> contains, Map<String, String> cssStyles,
			String elementName, String height, List<String> left,
			List<String> parent, List<String> right, String styleGuideX,
			String styleGuideY, List<String> top, String width,
			int xMouseClickPoint, int yMouseClickPoint, String text) {
		super();
		this.bottom = bottom;
